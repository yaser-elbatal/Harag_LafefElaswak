                    ...
                    </TouchableOpacity>
                    {
                        auth ?
                            <TouchableOpacity style={[styles.Button, styles.position_R, lang === 'en' ? { transform: [{ rotate: "180deg" }] } : null]} transparent onPress={() => showUser('notification')}>
                                ...
                                {
                                    auth && countNoty !== 0 ?
                                        <View style={[styles.position_A, styles.bg_orange, styles.Radius_5, styles.width_20, styles.height_20, styles.flexCenter, { top: -10, right: 0 }]}>
                                                        ...
                                                        array.map((cate, index) => {
                                                            return (
                                                                <TouchableOpacity
                                                                    ...
                                                                    style={[styles.paddingHorizontal_15, styles.Border, styles.paddingVertical_5, styles.marginHorizontal_10, categoryId === cate.id ? [styles.border_orange1, styles.bg_orange] : [styles.border_light_gray], { borderRadius: 5 }]}>
